...
/** a maximum value */
export interface Maximum<N extends number> extends PropertyConstraint {}

/** a minimum value */
export interface Minimum<N extends number> extends PropertyConstraint {}

/** range **/
export interface Range<L extends number, H extends number> extends Maximum<H>, Minimum<L>{}
